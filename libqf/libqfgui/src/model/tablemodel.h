...
class QFGUI_DECL_EXPORT TableModel : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	...
	class QFGUI_DECL_EXPORT TreeTableExportOptions : public QVariantMap
	{
...
protected:
	...
	bool m_columnsAutoGenerated = false;
