...
ReportItem::PrintResult ReportItemDetail::printMetaPaint(QPrinter *printer, ReportItemMetaPaint *out, const ReportItem::Rect &bounding_rect)
{
	qfLogFuncFrame();
	...
	--*/
	PrintResult res = Super::printMetaPaint(printer, out, bounding_rect);
