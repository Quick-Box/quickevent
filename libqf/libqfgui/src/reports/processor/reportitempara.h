...
#ifndef QF_GUI_REPORTS_REPORTITEMPARA_H
#define QF_GUI_REPORTS_REPORTITEMPARA_H
...
class QFGUI_DECL_EXPORT ReportItemPara : public ReportItemFrame
{
	Q_OBJECT
...
#endif // QF_GUI_REPORTS_REPORTITEMPARA_H
