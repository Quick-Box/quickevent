...
ReportItem::PrintResult ReportItemReport::printMetaPaint(QPrinter *printer, ReportItemMetaPaint *out, const ReportItem::Rect &bounding_rect )
{
	...
	PrintResult res = Super::printMetaPaint(printer, out, designedRect);
